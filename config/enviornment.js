...
module.exports = eval(process.env.CODIEAL_ENVIORNMENT) == undefined ? development : eval(process.env.CODIEAL_ENVIORNMENT);
// module.exports =development
 console.log(process.env.CODIEAL_ENVIORNMENT)
